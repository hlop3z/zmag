terminal("#terminal-index", [
  { type: "input", value: 'python -m pip install "zmag[testing]"' },
  { type: "progress", value: 100 },
  { value: "Successfully installed zmag", startDelay: 0 },
]);
...
terminal("#terminal-getting-started-installation", [
  {
    type: "input",
    value: 'pdm add "zmag[testing]"',
    startDelay: 0,
  },
  {
    value: "Adding packages to default dependencies: zmag",
    startDelay: 0,
  },
  { type: "progress", value: 100 },
  {
